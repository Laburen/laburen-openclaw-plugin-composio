...
- **Docs/README:** El ejemplo de `userId` en los comandos `openclaw config set` usa el placeholder `"user-id"` en lugar de `"your-stable-user-id"`.
- **Docs/Changelog:** En la entrada de la versión 0.0.9 se elimina la sección **Fixes** (nota sobre el workflow de publicación y la rama `main`).
